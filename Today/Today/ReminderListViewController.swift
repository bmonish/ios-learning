...
//            print(cell)
    ...
    private func refreshProgressView() {
        ...
        //        print("Checking CGFloat", CGFloat(percentComplete))
        //        print("Checking constraint Height and total height", totalHeight * CGFloat(percentComplete), totalHeight)
        percentCompleteHeightConstraint.constant = totalHeight * CGFloat(percentComplete)
        
        /* The layoutSubviews() method uses constraints that you’ve set to determine the size and position of any subviews.
         By placing the call to layoutSubviews() inside an animation block, you animate changes to the height of the progress
         complete view with a 0.2-second duration. */
